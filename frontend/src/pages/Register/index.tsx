...
import { Icon, Select, CardHeader, Heading, useToast, IconButton, Link, InputLeftElement, FormControl, FormHelperText, Show, Hide, HStack, Button, Flex, Text, FormLabel, VStack, Input, Alert, AlertIcon, InputGroup, InputRightElement, useColorMode, Box, Center, Stack, Card, CardBody } from '@chakra-ui/react';
import { SunIcon, MoonIcon, ViewIcon, ViewOffIcon, UnlockIcon, ArrowBackIcon, UpDownIcon } from '@chakra-ui/icons';
...
const registerUserFormSchema = z.object({
    ...
    matriculation: z.string()
        .nonempty('A Matricula é obrigatório'),
    email: z.string()
                            ...
                            <CardBody>
                                <form onSubmit={handleSubmit(registerUser)} >
                                    <FormControl isInvalid={errors.name != null} mb={3}>
                                        ...
                                        <InputGroup>
                                            <InputLeftElement pointerEvents='none'>
                                                <Icon as={MdPerson} color={isFocusedName ? "green_light" : "gray.400"} />
                                            </InputLeftElement>
                                            <Input
                                                width='330px'
                                    ...
                                    <FormControl isInvalid={errors.email != null} mb={3}>
                                        ...
                                        <InputGroup>
                                            <InputLeftElement pointerEvents='none'>
                                                <Icon as={MdEmail} color={isFocusedEmail ? "green_light" : "gray.400"} />
                                    ...
                                    <FormControl isInvalid={errors.matriculation != null} mb={3}>
                                        ...
                                        <InputGroup>
                                            <InputLeftElement pointerEvents='none'>
                                                <Icon as={IoMdDocument} color={isFocusedMatriculation ? "green_light" : "gray.400"}/>
                                            </InputLeftElement>
                                            <Input
                                                width='330px'
                                                focusBorderColor='#3CB371'
                                        ...
                                        {errors.matriculation && <FormHelperText color='red'>{errors.matriculation.message}</FormHelperText>}
                                    ...
                                    <FormControl isInvalid={errors.passwordconfirm != null} mb={3}>
                                        {/* <FormLabel htmlFor="password" >Confirme sua senha</FormLabel> */}

                                        <InputGroup size='md'>
                                            <InputLeftElement pointerEvents='none'>
                                                <LockIcon color={isFocusedPasswordConfirm ? "green_light" : "gray.400"} />
                                            </InputLeftElement>
                                            <Input
                                                bg='primary'
                                                focusBorderColor='#3CB371'
                                        ...
                                        {errors.passwordconfirm && <FormHelperText color='red'>{errors.passwordconfirm.message}</FormHelperText>}
                                    </FormControl>

                                    
                                    <FormControl
                                        isInvalid={errors.institute_id != null}
                                        mb={3}
                                    >
                                        <InputGroup>
                                            <Select
                                            ...
                                            >
                                                {institutes?.map(
                                                    (item: { id: string; name: string }) => (
                                                        <option key={item.id} value={item.id} className="custom-option">
                                                            {item.name}
                                                        </option>
                                                    )
                                                )}
                                    ...
                                    <Button isLoading={isSubmitting}
                                        mt='1rem'
                                        type='submit'
                                        variant="solid" w="100%">Cadastrar</Button>
                                </form>
                            </CardBody>
                        </Card>
                        <Hide below='md' >
                            <Box maxW="400px" pt='10' pb='10'>
                                ...
                                <Text fontSize="lg" mt={10}>
                                    Monitore o progresso de suas atividades, acompanhe cada etapa e visualize o processo completo de cada uma, seja Trabalho de Conclusão de Curso (TCC), estágio, atividades complementares ou outras.  </Text>
                                <Text fontSize="sm" mt={10} mb={10}>
                                    Entre em contato com seu coordenador para mais informações. </Text>
